...
MODEL_HOOP_PATH = r'drone_over_the_ring\resources\yolov11_hoop_e50.pt' # Chemin d'accès au modèle Hoop
MODEL_HEX_PATH = r'drone_over_the_ring\resources\runs\detect\train5\weights\best.pt' # Chemin d'accès au modèle Hex
...
HAUTEUR_REELLE_HEX_VERTICAL = 0.55 * 2.40
